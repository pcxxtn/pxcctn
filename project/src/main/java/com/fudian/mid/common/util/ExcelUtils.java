package com.fudian.mid.common.util;
...
import com.fudian.mid.common.handler.ExportHandler;
import com.fudian.mid.common.util.poi.convert.ExportConvert;
import com.fudian.mid.common.util.poi.pojo.ExportItem;
...
public class ExcelUtils {
	...
	private void required$BuilderParams() {
		if (mClass == null) {
			throw new IllegalArgumentException("请先使用com.fudian.mid.util.ExcelUtils.$Builder(Class<?>)构造器初始化参数。");
		}
	}
	...
	private void required$ExportParams() {
		if (mClass == null || mResponse == null) {
			throw new IllegalArgumentException(
					"请先使用com.fudian.mid.util.ExcelUtils.$Export(Class<?>, HttpServletResponse)构造器初始化参数。");
		}
