...
import com.fudian.mid.system.service.DictService;
...
public class DictController extends BaseController {
	...
	@Log("字典查询")
	@RequestMapping("dict/findByParam")
	@ResponseBody
	public List findDictBytbname(Dict dict){
		List list=this.dictService.findDictBytbname(dict);
		return list;
	}
